...
function c(a) {
    ...
    if (a.length === 1) {
        let e = a[0];
        return e ? {
            [e.field]: e.operator === "eq" || !e.operator ? e.value : {
                [f(e.operator)]: e.value
            }
        } : void 0;
    }
    let l = a.filter((e)=>e.connector === "AND" || !e.connector), s = a.filter((e)=>e.connector === "OR"), o = l.map((e)=>({
            [e.field]: e.operator === "eq" || !e.operator ? e.value : {
                [f(e.operator)]: e.value
            }
        })), r = s.map((e)=>({
            [e.field]: {
                [e.operator || "eq"]: e.value
            }
        }));
    return {
        AND: o.length ? o : void 0,
        OR: r.length ? r : void 0
    };
}
var y = (a, l)=>{
    let s = a, o = l.generateId;
    return {
        id: "prisma",
        async create (r) {
            let { model: e, data: n, select: t } = r;
            return o !== void 0 && (n.id = o ? o() : void 0), await s[e].create({
                data: n,
                ...t?.length ? {
                    select: t.reduce((d, i)=>({
                            ...d,
        ...
        async findOne (r) {
            let { model: e, where: n, select: t } = r, d = c(n);
            return await s[e].findFirst({
                where: d,
                ...t?.length ? {
                    select: t.reduce((i, u)=>({
                            ...i,
        ...
        async findMany (r) {
            let { model: e, where: n, limit: t, offset: d, sortBy: i } = r, u = c(n);
            return await s[e].findMany({
                where: u,
                take: t || 100,
                skip: d || 0,
                orderBy: i?.field ? {
                    [i.field]: i.direction === "desc" ? "desc" : "asc"
                } : void 0
            });
        },
        async update (r) {
            let { model: e, where: n, update: t } = r;
            t.id && (t.id = void 0);
            let d = c(n);
            return n.length === 1 ? await s[e].update({
                where: d,
                data: t
            }) : await s[e].updateMany({
                where: d,
                data: t
            });
        },
        async delete (r) {
            let { model: e, where: n } = r, t = c(n);
            return await s[e].delete({
                where: t
            }).catch((d)=>{});
        },
        async deleteMany (r) {
            let { model: e, where: n } = r, t = c(n);
            return await s[e].deleteMany({
                where: t
            });
        },
        options: l
...
//# sourceMappingURL=node_modules_better-auth_dist_4b82deaa._.js.map